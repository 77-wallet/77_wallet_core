...
pub fn predict_transaction_size(
    ...
    match address_type {
        ...
        BtcAddressType::P2sh => {
            ...
            let sign = "3045022100a76cc48098d4b512b210fb35de1841d2d02886ffffad13fba4cc059dde9ead8002205a568df055e6aae4cde47760e537cbc3c497154d6f08e2a538dc2330943f58a001";
            for _i in 0..2 {
                let rs = hex_func::hex_decode(sign)?;
            ...
            // 添加一个赎回脚本
            let red = "5221022b1c8becf58ce0a7db2eaf5666f295c7c8343077e09a0b2666eb51f1cbc084462102923ae9757390d24e39439d7bd337f1cbfdce38048ee004afd88e1cea099719bf21024a9c26d9c395129c8c097a7b255568410ea9d4c093b229b8c96a25f3435bdc1453ae";
            let rs = hex_func::hex_decode(red)?;
            let sign_bytes = rs.as_slice();

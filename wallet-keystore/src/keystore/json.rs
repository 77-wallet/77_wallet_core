use super::factory::{KdfAlgorithm, KdfParams};
...
pub struct CryptoJson {
    ...
    #[serde(
        serialize_with = "super::factory::buffer_to_hex",
        deserialize_with = "super::factory::hex_to_buffer"
    )]
...
#[cfg(test)]
mod tests {
    use crate::keystore::factory::{Pbkdf2Params, ScryptParams};
    use hex::FromHex;
